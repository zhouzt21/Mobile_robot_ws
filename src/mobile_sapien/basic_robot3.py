...
def demo(fix_root_link, balance_passive_force):
    ...
    robot: sapien.Articulation = loader.load("mobile_manipulator.urdf")#("tinker_display.urdf")  #"../assets/robot/jaco2/jaco2.urdf")  _copy
    # robot.set_root_pose(sapien.Pose([0, 0, 0], [1, 0, 0, 0]))

    # Set initial joint positions
    arm_init_qpos = [0, 0 ,0, 0, 0, 0, 0]#[0, 0.5 ,0, -0.2, 0, 0, 2]
